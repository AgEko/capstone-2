        ...
        switch (choice){
            ...
            case 2:
                if(!objectExists(WorldState.getInstance().game.player.getInventory(), Blackjack.class)){
                    ...
                    awaitInput("The CrimeBoss considers if he will help you." +
                            "\n\"I do 'av it in for that ponce. I'll cut ye a deal, on a real fine piece of merchandise to get ye past the guards.\"");
