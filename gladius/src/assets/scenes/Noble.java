            ...
            switch (choice){
                ...
                case 2:
                    if (!WorldState.getInstance().isStoleFromNoble()  && !WorldState.getInstance().isHasBlackjack()){
                        ...
                        awaitInput("On your way out a guard spots you and raises the alarm. You try to flee but all the gold weighs you down. The guards quickly apprehend you. The Captain of the guard takes you before the Noble Lord.");
